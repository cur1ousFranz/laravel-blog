...
<body class="antialiased min-h-screen bg-gray-50">
    ...
    <main class="max-w-screen-xl mx-auto mb-12">
        <div class="flex justify-end">
            <a class="absolute right-0 text-center w-full px-4 py-2 text-sm space-x-1 -tracking-tight hover:underline text-gray-700 bg-green-400 hover:bg-green-500 lg:w-fit" href="https://vrlps.co/ksqmnq8/cp" target="_blank">
