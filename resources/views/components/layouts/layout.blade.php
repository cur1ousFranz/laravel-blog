...
<body class="antialiased min-h-screen bg-gray-50">
    ...
    <x-layouts.nav-bar/>
        <div class="p-4 w-full rounded text-end">
            <a class="px-4 py-2 space-x-1 -tracking-tight text-gray-700 bg-yellow-300 hover:bg-yellow-400" href="https://vrlps.co/ksqmnq8/cp" target="_blank">
