<nav class="relative px-4 py-4 flex justify-between items-center border bg-white">
    ...
    <a class="hidden px-4 py-1 text-sm space-x-1 -tracking-tight text-gray-700 bg-green-300 hover:bg-green-400 lg:block" href="https://vrlps.co/ksqmnq8/cp" target="_blank">
